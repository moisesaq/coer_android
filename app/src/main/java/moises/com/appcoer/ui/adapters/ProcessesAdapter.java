...
public class ProcessesAdapter extends RecyclerView.Adapter<ProcessesAdapter.CourseViewHolder>{

    private Context mContext;
    private List<Course> courseList;
    private CallBack mCallBack;

    public ProcessesAdapter(Context context, List<Course> courses, CallBack callBack){
